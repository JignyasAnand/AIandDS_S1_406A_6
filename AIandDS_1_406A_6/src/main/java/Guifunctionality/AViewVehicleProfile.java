...
public class AViewVehicleProfile {
    ...
    Frame frame;
    public void Framex(VehicleEntity ve) {
		frame = new Frame();
		
		viewvehicleinfo(frame, ve);
			// admin
...
//			frame.setVisible(true);
    ...
    public void viewvehicleinfo(final Frame frame, VehicleEntity ve) {
...
//        descPanel.add(descheading, BorderLayout.NORTH);
        ...
        jb.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				f.dispose();
				Avehicleview av = new Avehicleview();
				av.Frame7();
